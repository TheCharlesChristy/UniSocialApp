 ...
 * 
 * Also handles profile updates via PUT request
...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        $user = $Database->query(
            "SELECT 
                ...
                profile_picture, bio, date_of_birth, registration_date, 
                account_status, role 
            FROM users 
            WHERE user_id = ?", 
            [$authUser['user_id']]
    ...
    case 'PUT':
    case 'POST': // Support POST as fallback for clients that don't support PUT
        // Parse input data
